...
//  <div className="flex justify-center items-center gap-2 border border-gray-300 rounded-lg py-2 mt-5 w-60 mx-auto coursor-pointer hover:bg-gray-100 transition-all">
//      <FaGoogle></FaGoogle>
// <button className='btn  text-blue-500 '> Login with Google</button>
//  </div>
//  <p className="text-center mt-5">If you don't have an account? <Link className='text-blue-500' href={'/register'}>Sign Up</Link> </p>
//     </Card>
//   );
// }
